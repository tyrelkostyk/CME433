...
add wave -noupdate /final_exam_testbench/count_en
add wave -noupdate -color Red -radix hexadecimal /final_exam_testbench/counter
...
WaveRestoreCursors {{Cursor 1} {20295999 ps} 0}
...
update
WaveRestoreZoom {12930362 ps} {30065160 ps}
